    <div class="node">
        <div class="content">
            <h2><span>Zaměstnanci</span><br />Přidat nového</h2><span class="button"><a href="index.php?page=user">&laquo; Zpět na zaměstnance</a></span><form method="post" action="index.php?page=user_process">
                <fieldset>
                 ...
                 <input type="submit" name="new_user" value="Uložiť"/>
                 </form>        </div>
    </div>